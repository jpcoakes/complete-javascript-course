...
// Jonas has access to the calcAge method because of prototypal inheritance
jonas.calcAge();
matilda.calcAge();
...
class StudentCl extends PersonCl {
  constructor(fullName, birthYear, course) {
    // Always needs to happen first! because this keyword is set by the super()
...
rivian.accelerate();
rivian.accelerate().brake().brake().brake().chargeBattery(50);
console.log(rivian);
