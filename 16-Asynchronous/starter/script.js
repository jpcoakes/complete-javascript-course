...
const renderCountry = function (data, className = '') {
  const html = `<article class="country ${className}"><img class="country__img" src="${data.flags.png}" />
...
// Promise.race
// returns the first promise that gets settled
// short circuits whenever one of the promises gets settled.
/*
(async function () {
...
// Promise.allSettled
// return an array of all the settled promises no matter if they were rejected or resolved
Promise.allSettled([
...
// Short circuits as soon as one promise rejects
Promise.all([
  Promise.resolve('Success'),
  Promise.reject('ERROR'),
  Promise.resolve('Another Success'),
